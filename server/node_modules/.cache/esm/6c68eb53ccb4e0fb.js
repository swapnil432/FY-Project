let Property;_ccb‍.x([["uploadPropertyInfo",()=>uploadPropertyInfo],["uploadPropertyImages",()=>uploadPropertyImages],["getPropertyData",()=>getPropertyData],["getProperty",()=>getProperty],["getHomeProperties",()=>getHomeProperties],["changePropertyPrice",()=>changePropertyPrice],["changePropertyOwner",()=>changePropertyOwner]]);_ccb‍.w("../models/property",[["default",["Property"],function(v){Property=v}]]);
  ...
  Property.find({ status: 1 }, (err, properties) => {
    ...
    return res.status(200).json(properties);
       ...
       const changePropertyPrice = (req, res) => {
  const id = req.params.id;
  ...
  Property.findOne({ _id: id }).exec((err, property) => {
    ...
    if (err || !property) {
      return res.status(400).json({
       ...
       const changePropertyOwner = (req, res) => {
  const id = req.params.id;
