let jwt,Admin,Property,User;_4da‍.x([["login",()=>login],["getAllProperty",()=>getAllProperty],["getProperty",()=>getProperty],["verifyProperty",()=>verifyProperty],["getPropertyDocuments",()=>getPropertyDocuments],["getPropertyImages",()=>getPropertyImages],["statusApprove",()=>statusApprove],["statusReject",()=>statusReject],["downloadDocuments",()=>downloadDocuments],["getAllUsers",()=>getAllUsers],["getCompleteUsers",()=>getCompleteUsers],["verifyUser",()=>verifyUser],["rejectUser",()=>rejectUser]]);_4da‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_4da‍.w("../models/admin",[["default",["Admin"],function(v){Admin=v}]]);_4da‍.w("../models/property",[["default",["Property"],function(v){Property=v}]]);_4da‍.w("../models/user",[["default",["User"],function(v){User=v}]]);
...
// Property
  ...
  Property.findOne({ _id: id }, (err, property) => {
    ...
    pdfs.forEach((filename) => {
      ...
      _4da‍.g.console.log("file : ", filepath);
