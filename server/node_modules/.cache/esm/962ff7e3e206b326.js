let jwt,Admin,Property,User;_e20‍.x([["login",()=>login],["getAllProperty",()=>getAllProperty],["getProperty",()=>getProperty],["verifyProperty",()=>verifyProperty],["getPropertyDocuments",()=>getPropertyDocuments],["getPropertyImages",()=>getPropertyImages],["statusApprove",()=>statusApprove],["statusReject",()=>statusReject],["downloadDocuments",()=>downloadDocuments],["getAllUsers",()=>getAllUsers],["getCompleteUsers",()=>getCompleteUsers],["verifyUser",()=>verifyUser],["rejectUser",()=>rejectUser]]);_e20‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_e20‍.w("../models/admin",[["default",["Admin"],function(v){Admin=v}]]);_e20‍.w("../models/property",[["default",["Property"],function(v){Property=v}]]);_e20‍.w("../models/user",[["default",["User"],function(v){User=v}]]);
...
// Property
  ...
  Property.findOne({ _id: id }, (err, property) => {
    ...
    pdfs.forEach((filename) => {
      ...
      _e20‍.g.console.log("file : ", filepath);
