let SellerOffer;_2cf‍.x([["sellProperty",()=>sellProperty],["getSellOffer",()=>getSellOffer],["deleteSellOffer",()=>deleteSellOffer]]);_2cf‍.w("../models/sellerOffer",[["default",["SellerOffer"],function(v){SellerOffer=v}]]);

       const sellProperty = async (req, res) => {
  const propId = req.params.id;
  const { seller_id, buyer_id, current_price } = req.body;
  _2cf‍.g.console.log(req.body)
