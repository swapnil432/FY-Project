let jwt,Admin,Property,User;_37b‍.x([["login",()=>login],["getAllProperty",()=>getAllProperty],["getProperty",()=>getProperty],["verifyProperty",()=>verifyProperty],["getPropertyDocuments",()=>getPropertyDocuments],["getPropertyImages",()=>getPropertyImages],["statusApprove",()=>statusApprove],["statusReject",()=>statusReject],["downloadDocuments",()=>downloadDocuments],["getAllUsers",()=>getAllUsers],["getCompleteUsers",()=>getCompleteUsers],["verifyUser",()=>verifyUser]]);_37b‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_37b‍.w("../models/admin",[["default",["Admin"],function(v){Admin=v}]]);_37b‍.w("../models/property",[["default",["Property"],function(v){Property=v}]]);_37b‍.w("../models/user",[["default",["User"],function(v){User=v}]]);
...
// Property
  ...
  Property.findOne({ _id: id }, (err, property) => {
    ...
    output.on("close", () => {
      _37b‍.g.console.log(archive.pointer() + " total bytes");
