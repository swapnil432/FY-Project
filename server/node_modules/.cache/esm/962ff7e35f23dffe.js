let jwt,Admin,Property,User;_5f2‍.x([["login",()=>login],["getAllProperty",()=>getAllProperty],["getProperty",()=>getProperty],["verifyProperty",()=>verifyProperty],["getPropertyDocuments",()=>getPropertyDocuments],["getPropertyImages",()=>getPropertyImages],["statusApprove",()=>statusApprove],["statusReject",()=>statusReject],["downloadDocuments",()=>downloadDocuments],["getAllUsers",()=>getAllUsers],["getCompleteUsers",()=>getCompleteUsers],["verifyUser",()=>verifyUser],["rejectUser",()=>rejectUser]]);_5f2‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_5f2‍.w("../models/admin",[["default",["Admin"],function(v){Admin=v}]]);_5f2‍.w("../models/property",[["default",["Property"],function(v){Property=v}]]);_5f2‍.w("../models/user",[["default",["User"],function(v){User=v}]]);
...
// Property
  ...
  Property.findOne({ _id: id }, (err, property) => {
    ...
    pdfs.forEach((filename) => {
      ...
      _5f2‍.g.console.log("file : ", filepath);
