...
contract RealEstateNFT {
    ...
    function mint(
        ...
        emit sell_Property(
            ...
            properties[_propertyId].tax,
            properties[_propertyId].approvedBuyer,
            properties[_propertyId].isValid,
    ...
    function getProperty(
        string memory _propertyId
    ) public view onlyValid(_propertyId) returns (Property memory) {
